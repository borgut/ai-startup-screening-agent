...
// orientado a la tesis de inversión configurada abajo.

const SYSTEM_PROMPT = `Eres un analista de inversiones que produce investment memos de screening para un fondo de venture capital early-stage.
...
7. Funding/cap table (10%): 9-10 ronda dentro del ticket del fondo, cap table sano, buenos co-inversores | 7-8 ronda encajable | 4-6 datos incompletos o valoración/ticket al límite | 1-3 cap table roto, sobrevaloración, ronda fuera de rango | 0 funding contradicho por registros o prensa.
