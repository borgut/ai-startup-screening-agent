(async () => {
  ...
  const t = {
    es: {
      ...
      compTitle:'Rondas públicas <em>comparables</em>', compNote:'Son rondas anunciadas, no valoraciones. Sirven para calibrar el tamaño y momento de la financiación, no para fingir un múltiplo que la fuente no publica.', th:['Startup','Vertical','Ronda','Fuente'], source:'Ver ↗', noVc:'Sin ARR no hay base suficiente para aplicar el método VC. Añade ARR o usa el scorecard como referencia inicial.', disclaimer:'Herramienta orientativa, no una tasación ni asesoramiento financiero. El rango depende de supuestos editables y datos aportados por ti. Una valoración real también depende de términos, dilución, preferencia de liquidación, geografía y negociación.',
    },
    en: {
      ...
      compTitle:'Public <em>comparable rounds</em>', compNote:'These are announced rounds, not valuations. They calibrate financing size and timing; they do not invent a multiple the source did not publish.', th:['Startup','Vertical','Round','Source'], source:'View ↗', noVc:'Without ARR there is not enough basis for the VC method. Add ARR or use scorecard as an initial reference.', disclaimer:'Indicative tool, not a valuation or financial advice. The range depends on editable assumptions and the data you provide. A real valuation also depends on terms, dilution, liquidation preference, geography and negotiation.',
    }
  };
