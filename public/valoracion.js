(async () => {
  ...
  const t = {
    ...
    en: {
      ...
      compTitle:'Public <em>comparable rounds</em>', compNote:'These are announced rounds, not valuations. They calibrate financing size and timing; they do not invent a multiple the source did not publish.', th:['Startup','Vertical','Round','Source'], source:'View ↗', noVc:'Without ARR there is not enough basis for the VC method. Add ARR or use scorecard as an initial reference.', nextLabel:'The full journey', next:[['/red-team-idea','Have a VC tear it apart first →'],['/investor-map','Who invests at that range →']], disclaimer:'Indicative tool, not a valuation or financial advice. The range depends on editable assumptions and the data you provide. A real valuation also depends on terms, dilution, liquidation preference, geography and negotiation.',
    }
  };
